...
<body>
    ...
    <header>
        ...
        <div class="user">
            <!-- <img src="assets/user-regular.png" alt=""> -->
            <a href=""></a>
        </div>
        <div class="logout">
            ...
            <div class="wrapper">
                <div class="slide">
                    <div class="content">
                        ...
                        <h3>Smartphone</h3>
                        <p>Dapatkan Segera Koleksi Gadget Terbaru dan Favorit Anda dengan Harga Mulai Dari Rp 1 Jutaan, Promo Spesial Diskon Akhir Tahun Buruan Cek Jangan Sampai Ketinggalan.</p>
                        <a href="login.html" class="btn" id="btn-order">order now</a>
                    </div>
                    <div class="image">
    ...
    <section class="about" id="promotion">
        ...
        <h1 class="heading">popular gadget</h1>
            ...
            <div class="content">
                ...
                <a href="login.html" class="btn" id="btn-about">learn more</a>
            </div>
